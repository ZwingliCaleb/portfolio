...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-b from-gray-950 to-gray-900 text-[#f9b17a] py-30 px-10 text-left min-h-[740px] md:min-h-auto md:py-25 md:px-5" id="Home">
